...
Kliknięcie w przycisk "Załóż konto"|Przycisk "załóż konto" jest przyceimniony i nie ma możliwości kliknięcia w niego|	&#x2611;
<br>
...
### Przypadek testowy numer 6: weryfikacja poprawności wysłania linku potwierdzającgo założenie konta 		
